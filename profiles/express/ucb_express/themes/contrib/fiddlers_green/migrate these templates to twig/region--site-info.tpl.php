...
?>
  ...
  <footer id="site-footer" class="<?php print $classes; ?>">
    ...
    <div id="cu-footer" class="<?php print $class; ?>">
        <p><a href="//www.colorado.edu"><img src="<?php print $base_url . '/' . drupal_get_path('theme', 'ucb_expressbase'); ?>/images/beboulder/be-boulder-<?php print $beboulder['color']; ?>.png" alt="University of Colorado Boulder" class="beboulder"/></a></p>
