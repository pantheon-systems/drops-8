...
class WebformAlterHooksTest extends WebformNodeTestBase {
  ...
  public function testWebformAlterHooks() {
    ...
    $this->assertRaw("hook_form_alter(): 'webform_submission_contact_form' executed.");
    $this->assertRaw("hook_form_webform_submission_form_alter(): 'webform_submission_contact_form' executed.");
    $this->assertRaw("hook_form_webform_submission_WEBFORM_ID_form_alter(): 'webform_submission_contact_form' executed.");
    ...
    $this->assertRaw("hook_form_alter(): 'webform_submission_contact_node_{$nid}_form' executed.");
    $this->assertRaw("hook_form_webform_submission_form_alter(): 'webform_submission_contact_node_{$nid}_form' executed.");
    $this->assertRaw("hook_form_webform_submission_WEBFORM_ID_form_alter(): 'webform_submission_contact_form' executed.");
  }
